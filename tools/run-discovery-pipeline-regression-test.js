...
const files = [
  ...
  'apps-script/src/DiscoveryPipelineRegressionTest.gs'
];
...
if (
  typeof context.runDiscoveryPipelineRegressionTest !==
  'function'
) {
  throw new Error(
    'runDiscoveryPipelineRegressionTest was not loaded.'
  );
}

context.runDiscoveryPipelineRegressionTest();

console.log(
  'LOCAL DISCOVERY PIPELINE REGRESSION TEST: PASSED'
);
