...
const files = [
  ...
  'apps-script/src/FullLocalDiscoveryPipelineTest.gs'
];
...
if (
  typeof context.runFullLocalDiscoveryPipelineTest !==
  'function'
) {
  throw new Error(
    'runFullLocalDiscoveryPipelineTest was not loaded.'
  );
}

context.runFullLocalDiscoveryPipelineTest();

console.log(
  'LOCAL FULL DISCOVERY PIPELINE TEST: PASSED'
);
